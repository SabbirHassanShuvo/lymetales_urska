...
<div style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:0.75rem;margin-bottom:1.5rem">
    <div>
        ...
        <h2 style="font-size:1.5rem;font-weight:800;color:#111827;margin:0">Edit Privacy Policy</h2>
        <p style="font-size:0.85rem;color:#9ca3af;margin-top:0.25rem">Manage the Privacy Policy sections</p>
    </div>
...
<div class="card">
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:1.1rem">
        <div class="card-title" style="margin-bottom:0"><span class="dot" style="background:#6366f1"></span> Policy Sections</div>
    ...
    <div style="display:flex;flex-direction:column;gap:0.75rem">
        <template x-for="(section, i) in sections" :key="i">
            <div style="border:1.5px solid #f1f2f4;border-radius:0.75rem;padding:1rem;position:relative">
                <button type="button" @click="sections.splice(i,1)" style="position:absolute;top:0.65rem;right:0.65rem;background:#fff5f5;color:#f87171;border:none;cursor:pointer;border-radius:0.4rem;padding:0.25rem 0.4rem;transition:background 0.15s" title="Remove">
                ...
                <div style="padding-right:2rem;display:flex;flex-direction:column;gap:0.6rem">
                    <div>
                        ...
                        <input type="text" :name="'section_title['+i+']'" x-model="section.title" class="input" placeholder="e.g. 1. Who we are">
                    </div>
                    <div>
