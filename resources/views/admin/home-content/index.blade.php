...
<div x-data="{ 
    ...
    editHeroModal: false,
    editHeroData: { id: '', title: '', button_one_text: '', button_two_text: '', image_url: '', language_type: 'SL' },
    openEditHero(hero) {
        this.editHeroData = {
            id: hero.id,
            title: hero.title,
            ...
            language_type: hero.language_type || 'SL'
        };
        this.editHeroModal = true;
    },
    editFeatureModal: false,
    editFeatureData: { id: '', title: '', description: '', language_type: 'SL' },
    openEditFeature(feat) {
        this.editFeatureData = {
            id: feat.id,
            title: feat.title,
            description: feat.description,
            language_type: feat.language_type || 'SL'
        };
        this.editFeatureModal = true;
    },
    editGiftModal: false,
    editGiftData: { id: '', title: '', subtitle: '', image_url: '', language_type: 'SL' },
    openEditGift(gift) {
        this.editGiftData = {
            id: gift.id,
            title: gift.title,
            ...
            language_type: gift.language_type || 'SL'
        };
        this.editGiftModal = true;
    },
    editFaqModal: false,
    editFaqData: { id: '', question: '', answer: '', language_type: 'SL' },
    openEditFaq(faq) {
        this.editFaqData = {
            id: faq.id,
            question: faq.question,
            answer: faq.answer,
            language_type: faq.language_type || 'SL'
        };
    ...
    <div class="mb-6 flex items-center justify-between bg-white p-4 rounded-xl shadow-sm border border-gray-100">
        <h2 class="text-lg font-semibold text-gray-800">Home Content Management</h2>
        <div class="flex items-center gap-3">
            <label class="text-sm font-medium text-gray-700">Global Language (for saving data):</label>
            <select onchange="window.location.href='?lang=' + this.value" class="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 bg-gray-50 font-medium">
                ...
                @forelse($heroSections as $hero)
                    <div class="border rounded-xl p-4 relative bg-gray-50 flex flex-col justify-between">
                        ...
                        <div>
                            ...
                            @endif
                            <div class="mb-2"><span class="px-2 py-0.5 bg-blue-100 text-blue-800 text-xs font-bold rounded">{{ $hero->language_type ?? 'SL' }}</span></div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                @forelse($features as $feat)
                    <div class="border rounded-xl p-4 relative bg-gray-50 flex flex-col justify-between">
                        ...
                        <div>
                            <div class="mb-2"><span class="px-2 py-0.5 bg-blue-100 text-blue-800 text-xs font-bold rounded">{{ $feat->language_type ?? 'SL' }}</span></div>
                ...
                @forelse($giftCards as $gift)
                    <div class="border rounded-xl p-4 relative bg-gray-50 flex flex-col justify-between">
                        ...
                        <div>
                            ...
                            @endif
                            <div class="mb-2"><span class="px-2 py-0.5 bg-blue-100 text-blue-800 text-xs font-bold rounded">{{ $gift->language_type ?? 'SL' }}</span></div>
            ...
            <div class="space-y-4">
                @forelse($faqs as $faq)
                    <div class="border rounded-xl p-4 relative bg-gray-50">
                        ...
                        <div class="mb-2"><span class="px-2 py-0.5 bg-blue-100 text-blue-800 text-xs font-bold rounded">{{ $faq->language_type ?? 'SL' }}</span></div>
