        ...
        <aside class="w-64 bg-white border-r border-gray-100 flex-shrink-0 relative">
            ...
            <nav class="mt-8 px-4 space-y-2 mb-24">
                ...
                <a href="{{ route('admin.translations.index') }}"
                    class="flex items-center px-4 py-3 {{ request()->routeIs('admin.translations.*') ? 'bg-indigo-50 text-indigo-700 font-semibold' : 'text-gray-600 hover:bg-gray-50' }} rounded-xl transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5h12M9 3v2m1.048 9.5A18.022 18.022 0 016.412 9m6.088 9h7M11 21l5-10 5 10M12.751 5C11.783 10.77 8.07 15.61 3 18.129"/>
                    </svg>
                    <span class="flex-1">CMS Manage</span>
                </a>
